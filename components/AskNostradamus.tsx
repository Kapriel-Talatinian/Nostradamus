...
export default function AskNostradamus() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#fefcfb] px-4 py-8 sm:py-12">
      <div className="relative bg-white shadow-xl rounded-2xl max-w-md w-full p-6 pt-16 sm:pt-20 pb-10 sm:pb-12">
        {/* Djinn Image centered above the title */}
        <div className="absolute left-1/2 -top-16 sm:-top-20 -translate-x-1/2 z-10">
          <Image
            src={getDjinnImage()}
